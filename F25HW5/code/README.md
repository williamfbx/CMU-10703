...
|-- td3.py 		# Implementation of TD3. You do not have to do anything to this file.
|-- train.py 		# Entry of all the TD3 experiments. *** You need to add code to this file. ***
|-- replay_buffer.py 		# Replay buffer for TD3. You do not have to do anything to this file.
```
